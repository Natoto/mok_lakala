Pod::Spec.new do |s|
  s.name         = "RNetworkEye"
  s.version      = "1.0.6"
  s.summary      = "RNetworkEye - a iOS network debug library ,It can monitor HTTP requests within the App and displays information related to the request."
  ...
  s.subspec 'standard' do |ss|
    ss.source_files = 'RNetworkEye/**/*.{h,m,png}'
  end
